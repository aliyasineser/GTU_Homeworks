...
public:
    ...
    const Cell operator[](std::string str) const;
    const Cell operator()(std::string y_coor, int x_coor) const;
    const Cell operator()(int x_coor, std::string y_coor) const;
    void operator+=(const Cell& move);
    void operator++(int);
    void operator++();
