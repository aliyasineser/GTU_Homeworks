...
/**
 * Assignable Group project class. User can create assignable Group project
 * objects for doing assignment to a quiz.
 *
 * @author Ali Yasin Eser
 */
public class AssignableGroupProject extends AbstractAssignable {
     ...
     * @param assignmentThatWeAddedDocuments, assignment that we added
     * documentws
     */
    public AssignableGroupProject(ArrayList<AbstractDocument> assignedDocuments, AbstractAssignment assignmentThatWeAddedDocuments) {
     ...
     * with the new object
     */
    public AssignableGroupProject(AbstractAssignable _abstractAssignable) {
